...
//	agent auth login|logout|list|status|usage ...
...
var subcommands = []subcommand{
	{"auth", "login [provider] [--method <id>] | logout [provider] | list | status [provider] | usage [provider]", [][2]string{
		{"login [provider] [--method <id>]", "sign in with a provider-managed account or subscription"},
		{"logout [provider]", "remove the stored provider login"},
		{"list", "list providers and their supported login methods"},
		{"status [provider]", "show safe account and credential metadata"},
		{"usage [provider]", "fetch current subscription usage"},
	}},
